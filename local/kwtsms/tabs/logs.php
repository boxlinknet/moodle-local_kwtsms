...
$records = $DB->get_records_select(
    'local_kwtsms_log', $where, $params, 'timecreated DESC', '*', $page * $perpage, $perpage
);
    ...
    <div class="form-row align-items-end">
        ...
        <div class="form-group col-md-2 mb-2">
            ...
            <input type="text" name="filter_search" id="filter_search" class="form-control"
                   value="<?php echo s($search); ?>" placeholder="<?php echo s(get_string('log_filter_search', 'local_kwtsms')); ?>">
        </div>
